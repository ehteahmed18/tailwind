...
export default function Outcome() {
    return (
        <>
            <div className="flex flex-wrap py-10 lg:space-x-28 space-y-4 md:space-y-0 md:space-x-12 space-x-0 lg:justify-center w-full border-b-2">
                <div className="flex flex-col  lg:justify-center px-6 items-start  w-full lg:w-5/12  md:w-6/12 lg:py-12 py-2 ">
                ...
                <div className="flex flex-col  justify-start  w-full md:w-5/12 ">
                    <div className="flex ">
                        <TbArrowBadgeRight className="lg:w-10 w-14 sm:h-16 h-14" />
                    ...
                    <div className="flex ">
                        <TbArrowBadgeRight className="lg:w-8 w-12 sm:h-16 h-14" />
                        <div className="flex flex-col py-4 lg:ml-4">
                    ...
                    <div className="flex ">
                        <TbArrowBadgeRight className="lg:w-6 w-12 sm:h-16 h-14" />
                        <div className="flex flex-col py-4 lg:ml-4">
