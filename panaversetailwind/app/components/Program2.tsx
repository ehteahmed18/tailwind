...
export default function Program2() {
    ...
    return (
        <>
            <motion.div className="flex flex-wrap-reverse pt-10  justify-center  w-full border-b-2" initial="hide" whileInView="show" exit="hide" variants={introHeaderVariants}>
