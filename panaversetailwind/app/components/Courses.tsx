            ...
            <div className=" w-full pb-20 pt-20  border-b-2    ">
                ...
                <div className=" space-y-8 py-4">
                    <div className="flex flex-wrap px-2 lg:space-x-10 justify-center w-full">
                        <div className="flex flex-col py-8 border-2 border-black rounded-lg my-2 w-full md:w-8/12 lg:w-3/12 text-center p-4 bg-red-200">
                    ...
                    <div className="flex flex-wrap px-2 lg:space-x-10 justify-center">
                        <div className="flex flex-col border-2 border-black py-8 rounded-lg my-2 w-full md:w-8/12 lg:w-3/12 text-center p-4 bg-red-200">
